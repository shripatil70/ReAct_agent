...
* Integrate external tools (search, APIs)
* Add memory for multi-step conversations
* Deploy as a web app
...
The `.env` file is not included for security reasons. Make sure to add your own API key before running the project.
